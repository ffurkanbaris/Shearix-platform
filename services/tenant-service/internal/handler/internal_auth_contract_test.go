...
func TestInternalAuthContract(t *testing.T) {
	...
	routes := []authcontract.Route{
		...
		authcontract.NewRoute(http.MethodGet, "/internal/v1/platform/tenants", false, "", 401, 0, 0),
		authcontract.NewRoute(http.MethodPost, "/internal/v1/platform/tenants/:id/activate", false, "", 401, 0, 0),
		authcontract.NewRoute(http.MethodPost, "/internal/v1/platform/tenants/:id/suspend", false, "", 401, 0, 0),
		authcontract.NewRoute(http.MethodGet, "/internal/v1/platform/audit", false, "", 401, 0, 0),
