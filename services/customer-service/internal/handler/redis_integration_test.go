...
func TestCustomerRedisRateLimitIntegration(t *testing.T) {
	redisURL := os.Getenv("CUSTOMER_TEST_REDIS_URL")
	if redisURL == "" {
		t.Skip("CUSTOMER_TEST_REDIS_URL is required")
	}
	...
	key := "customer-integration:" + uuid.NewString()
